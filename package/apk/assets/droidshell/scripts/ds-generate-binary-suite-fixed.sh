...
bash "$ROOT/scripts/ds-generate-binary-suite-fixed.sh" copy_runtime_tree
...
mkdir -p "$PKG/base/assets/droidshell" "$OUT"
...
echo "[BINFIX] Binary packaging suite fixed and installed."
